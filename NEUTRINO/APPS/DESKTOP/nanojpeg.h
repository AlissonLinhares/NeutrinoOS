//Projeto Neutrino v0.03 - 23/01/2012 - projetonos.wordpress.com
//Foram feitas 3 alterações na biblioteca NanoJPEG para que fosse possível 
//porta-la para o neutrino os.
//
//Alteração 1: Troca da stdlib pela nlib.
//Alteração 2: Troca da variável "nj_context_t nj" por "nj_context_t* njPtr"
//Alteração 3: Alocando espaço para "nj".
//
//	O formato bin reserva o espaço da bss em disco. Para evitar um aumento 
//significativo dos binários, a memória foi alocada pelo malloc. Não é necessário
//liberar o espaço alocado, o Neutrino libera automaticamente quando o programa termina!
...
/** ------------------------------------------------------------ */
/** Alteração 1 */
/** ----- Código portado para trabalhar com o neutrino os. ----- */
#include <memory.h>
#define NULL 0
#define njAllocMem (unsigned char*) nlib::Memory::malloc
#define njFreeMem  nlib::Memory::free
#define njFillMem  nlib::Memory::memset
#define njCopyMem  nlib::Memory::memcpy
#define nj (*njPtr)
/** ------------------------------------------------------------ */
...
/** Alteração 2 */
/** ----- Código portado para trabalhar com o neutrino os. ----- */
static nj_context_t *njPtr = 0;  //dynamic bss is not supported! //bss dinâmica não é suportada!
/** ------------------------------------------------------------ */
...
void njInit(void) {
    if( !njPtr )
	njPtr = (nj_context_t*) njAllocMem(sizeof(nj_context_t));
    njFillMem(&nj, 0, sizeof(nj_context_t));
}
/** ------------------------------------------------------------ */
